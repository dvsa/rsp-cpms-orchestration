...
export default groupTransactionData => {
  return new Promise((resolve, reject) => {
    ...
    const transactionOptions = buildGroupTransactionOptions(
      groupTransactionData
    );
    const validationResult = Validation.cpmsTransactionValidation(
      transactionOptions
    );
    ...
    transactionClient
      .post(groupTransactionData.endpoint, transactionOptions)
      .then(transactionResponse => {
        ...
        logInfo("CPMSGroupPaymentSuccess", {
          endpoint: groupTransactionData.endpoint,
          transactionOptions
        });
